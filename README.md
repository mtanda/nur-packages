...
|---------|---------|-------------|
| agmsg | v1.2.3 | Cross-vendor messaging for CLI AI coding agents — let Claude Code, Codex, Gemini & Copilot talk to each other in one team |
...
| github-comment | v6.4.1 | CLI to create and hide GitHub comments |
| hunk | 0.17.0 | Review-first terminal diff viewer for agentic coders |
